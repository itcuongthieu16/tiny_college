                    ...
                    <div class="card-body">
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="SEMESTER_TERM" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>SEMESTER_START_DATE</label>
                                <input type="text" name="SEMESTER_START_DATE" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>SEMESTER_END_DATE</label>
                                <input type="text" name="SEMESTER_END_DATE" class="form-control">
                            </div>
                            <div class="mb-3">
                                <button type="submit" name="save_semester" class="btn btn-primary">Save Semester</button>
                            </div>
